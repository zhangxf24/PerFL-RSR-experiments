...
for (pp in 1:length(p)) {  
  ...
  save.image(paste0('simulation-results/t_M10_n100_p',p[pp],'.Rdata'))
}
...
for (pp in 1:length(p)) {  
  ...
  save.image(paste0('simulation-results/normal_M10_n100_p',p[pp],'.Rdata'))
  
}


##### tune cauchy distribution #####
p <- c(15,100,200,300)
...
for (pp in 1:length(p)) {  
  ...
  save.image(paste0('simulation-results/cauchy_M10_n100_p',p[pp],'.Rdata'))
