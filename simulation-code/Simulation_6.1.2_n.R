### This simulation takes about 60 minutes for 
...
##### t distribution #####
n_list <- c(150,200,300)

for (pp in 1:length(n_list)) {
  M=10
  np = c(n_list[pp], 15)
  ...
  simu <- function(seed) {
    ...
    fit1_l2 <- PMfit(data, method = "l2", regularizer = "lasso",
                     ...
                     omega0 = Ufit$beta[,1], sigv, itermax = 200)
    ...
    fit1 <- PMfit(data, method = "Huber", regularizer = "lasso",
                  ...
                  omega0 = Ufit$beta[,4], sigv, itermax = 200)
  ...
  save.image(paste0('simulation-results/t_M10_n',n_list[pp],'_p15.Rdata'))
...
for (pp in 1:length(n_list)) {
  ...
  simu <- function(seed) {
    ...
    fit1 <- PMfit(data, method = "Huber", regularizer = "lasso",
                  lambda1=0.00774, lambda2=0.001, proportion = 1,
                  omega0 = Ufit$beta[,4], sigv, itermax = 500)
    fit2 <- PMfit(data, method = "Huber", regularizer = "MCP",
                  lambda1=1.668, lambda2=0.278, proportion = 1,
                  omega0 = Ufit$beta[,4], sigv, itermax = 500)
    fit3 <- PMfit(data, method = "Huber", regularizer = "SCAD",
  ...
  save.image(paste0('simulation-results/normal_M10_n',n_list[pp],'_p15.Rdata'))
...
for (pp in 1:length(n_list)) {
  ...
  simu <- function(seed) {
    ...
    fit1_l2 <- PMfit(data, method = "l2", regularizer = "lasso",
                     lambda1=0.00774, lambda2=0.00774, proportion = 1,
                     omega0 = Ufit$beta[,1], sigv, itermax = 1000)
    fit2_l2 <- PMfit(data, method = "l2", regularizer = "MCP",
                     lambda1=1.668, lambda2=0.278, proportion = 1,
                     omega0 = Ufit$beta[,1], sigv, itermax = 1000)
    fit3_l2 <- PMfit(data, method = "l2", regularizer = "SCAD",
    ...
    fit1 <- PMfit(data, method = "Huber", regularizer = "lasso",
                  lambda1=0.00774, lambda2=0.001, proportion = 1,
                  omega0 = Ufit$beta[,4], sigv, itermax = 1000)
    fit2 <- PMfit(data, method = "Huber", regularizer = "MCP",
                  lambda1=1.668, lambda2=0.278, proportion = 1,
                  omega0 = Ufit$beta[,4], sigv, itermax = 1000)
    fit3 <- PMfit(data, method = "Huber", regularizer = "SCAD",
  ...
  save.image(paste0('simulation-results/cauchy_M10_n',n_list[pp],'_p15.Rdata'))
